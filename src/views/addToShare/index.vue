<template>
  <div id="addToshare">
      <el-row>
        <el-col :span="24">
          <h3 style="margin-top:20px;margin-bottom:50px;text-align:center;">美国51区是否有外星人？</h3>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form ref="form" :model="form">
            ...
            <el-form-item>
              <el-button type="primary" @click="handleSee" class="cusee">
                添加至右侧预览
            ...
            <el-timeline-item
              ...
              <el-card>
                <div slot="header" class="clearfix ovfl">
                  ...
                  <el-button style="float:right;padding:0;" type="text" @click="deleEditedContent(item,index)">删除</el-button>
                </div>
                <p>{{item.content}}</p>
              </el-card>
            </el-timeline-item>
