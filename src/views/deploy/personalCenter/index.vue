<template>
	<div class="profile">
		<el-row :gutter="30">
			<el-col :span="7">
				<div class="profile-content ">
					...
					<div class="profile-info">
						...
						<p><svg-icon icon-class="tree" class="mr8"/> 蚂蚁金服－某某某事业群－某某平台部－UED</p>
						<p><i class="el-icon-map-location mr8" />浙江省杭州市</p>
					</div>
					<div class="ant-divider ant-divider-horizontal ant-divider-dashed" role="separator"></div>
					<div class="tags-warp">
						<div class="mu-tags">个性标签</div>
						<template v-for="(tag, index) in tags" >
							<a-tooltip v-if="tag.length > 20" :key="tag" :title="tag" class="mb8">
								<a-tag :key="tag" :closable="index !== 0" @close="() => handleClose(tag)">
								{{ `${tag.slice(0, 20)}...` }}
								</a-tag>
							</a-tooltip>
							<a-tag v-else :key="tag" :closable="index !== 0" @close="() => handleClose(tag)" class="mb8">
								{{ tag }}
							</a-tag>
						</template>
						<a-input
			...
			<el-col :span="17"><div class="profile-content ">
