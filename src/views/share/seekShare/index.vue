					...
					<el-radio-group v-model="form.shareMode">
						<el-radio :label="1">
							...
							>
								<p>
									1:
									您的打赏中90%(100%-10%)的象币将按一定比例90天内经验给每位经验者
									<el-tooltip
										class="item"
										effect="dark"
										content="算法： 每位经验者所得到的象币 = 发起者打赏象币的90% * 经验者个人获得的点赞数 / 所有经验者的总点赞数"
										placement="top-start"
									>
										<el-link
								...
								<p>
									2:
									您自己将会得到自己打赏自己的10%(既上面的10%)象币，因为发起经验的人，属于经验者的一种特殊群体
								</p>
								<p>
									3:
									只要有人打赏您发起的经验，或打赏您名下经验者的经验时，您都将固定获得打赏人总象币的10%;
									&nbsp;&nbsp;&nbsp;
									<b style="color: red">且是永久的</b>
								</p>
								<p>
									4:
									上架中的经验经验将在180天后，自动转为付费模式（0.1元/次）
								</p>
								<el-button
									slot="reference"
									class="tipRule"
						...
						<el-radio :label="2">
							...
							>
								<p>
									1:
									您打赏的象币将按一定比例90天内全部经验给每位经验者
									<el-tooltip
										class="item"
										effect="dark"
										content="算法： 每位经验者所得到的象币 = 发起者打赏象币的100% * 经验者个人获得的点赞数 / 所有经验者的总点赞数"
										placement="top-start"
									>
										<el-link
											icon="el-icon-question"
								...
								<p>
									2:上架中的经验经验将在180天后，自动转为付费模式（0.1元/次）
								</p>
								<el-button
									slot="reference"
									class="tipRule"
